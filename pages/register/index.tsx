  ...
  return (
    <Layout title="Đăng Ký">
      <div className="flex mb-5 flex-wrap lg:max-w-7xl mx-auto px-4 lg:px-16 mt-4">
        <p className="text-sm text-gray-500 font-semibold">Đăng Nhập</p>
        <p className="px-3 text-sm">/</p>
        <p className="text-mainColor font-semibold text-sm">Đăng Ký</p>
      </div>
          ...
          <div className="absolute top-10 bottom-10 lg:right-10 lg:left-10 right-6 left-6">
            ...
            <form>
              ...
              <div className="relative">
                ...
                />
                <UserIcon className="w-6 h-6 text-mainColor absolute top-4 left-3" />
              </div>
              ...
              <div className="relative">
                <input
                  className="text-mainColor focus:outline-none w-full px-12 py-3 rounded-lg bg-yellow-100 my-1"
                  type="password"
                  id="password"
                  name="password"
                  placeholder="Nhập họ của bạn"
                />
                <UserGroupIcon className="w-6 h-6 text-mainColor absolute top-4 left-3" />
              </div>
