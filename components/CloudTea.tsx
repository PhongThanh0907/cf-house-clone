...
const CloudTea = () => {
  ...
  const linkNextPage = () => {
    router.push({
      pathname: `/products/cloudtea`,
      query: {
        typeProduct: "cloudtea",
      },
    });
  };
  return (
        ...
        <div className="absolute left-0 bottom-10 right-0 top-10 z-10">
          <div className="px-4 lg:px-0 flex flex-col lg:flex-row max-w-7xl mx-auto lg:gap-8">
            ...
            <div className="py-10 lg:py-28">
              ...
              <button
                onClick={() => linkNextPage()}
                className="lg:px-28 lg:w-auto w-full rounded-xl font-semibold text-white py-2 bg-[#b3ddca] lg:my-4 hover:bg-[#9fd1b5] active:bg-[#8abea1] duration-300"
              >
                Thử ngay
              </button>
            </div>
